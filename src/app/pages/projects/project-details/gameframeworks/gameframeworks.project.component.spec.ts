...
import { GameFrameworksProjectComponent } from './gameframeworks.project.component';

describe('GameFrameworksProjectComponent', () => {
  let component: GameFrameworksProjectComponent;
  let dom: HTMLElement;
  let fixture: ComponentFixture<GameFrameworksProjectComponent>;
  ...
  beforeEach(async(() => {
    ...
    fixture = TestBed.createComponent(GameFrameworksProjectComponent);
